package com.example.navdrawertest2.ui.sobre;
...
import com.example.navdrawertest2.R;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addInstagram("testuser")
                .addFacebook("testuser", "Facebook")
                .addItem(versao)
                .create();
